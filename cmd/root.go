...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.LVScare.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".LVScare" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".LVScare")
	}
